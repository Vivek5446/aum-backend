...
const MONGO_URI = "mongodb+srv://mrityunjaygupta-aum:QaVH8R0ksCH2hNmH@aum-yoga-prod-01.ch2wcja.mongodb.net/userInfo"; // Change for your setup
...
const transporter = nodemailer.createTransport({
  ...
  auth: {
    user: OWNER_EMAIL,
    pass: "feyo tayu llhq wobv", // App-specific password
  },
});
...
app.post("/send-email", async (req:any, res:any) => {
  ...
  try {
    ...
    // 3. Save to MongoDB (only after emails are successful)
